              ...
              <div className="grid items-center gap-2">
                <div className="grid flex-1 auto-rows-min gap-0.5">
                  ...
                  <div className="flex items-baseline gap-1 text-2xl font-bold tabular-nums leading-none">
                    50
                    <span className="text-sm font-normal text-muted-foreground">cups</span>
                  </div>
                  {/* <div className="text-xs">₱575</div> */}
                </div>
                <div className="grid flex-1 auto-rows-min gap-0.5">
                  ...
                  <div className="text-xs tabular-nums leading-none text-muted-foreground">
                    ₱575
                    {/* <span className="text-sm font-normal text-muted-foreground">cups</span> */}
                  </div>
                </div>

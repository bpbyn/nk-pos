    ...
    <div className="mx-auto grid max-w-[59rem] flex-1 auto-rows-max gap-4">
      <div className="flex items-center gap-4">
        ...
        <Badge
          variant="secondary"
          className={cn(
            form.getValues('status') === productStatus.active.toLocaleLowerCase() &&
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea
                                ...
                                className="min-h-32 text-base placeholder:text-sm md:text-sm"
                                {...field}
                              />
                            </FormControl>
                            <FormMessage />
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormControl>
                                  <Input
                                    {...field}
                                    value={form.getValues(`size.${size}`)!}
                ...
                <div className="grid gap-2">
                  <div className="grid">
                    <Image
                      ...
                      height="300"
                      src={preview?.url ? preview?.url : '/placeholder.svg'}
                      width="300"
                      priority
